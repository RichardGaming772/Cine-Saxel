    <div class="box">
        ...
        <p>Pour ajouter un film à la base de données allez dans l'onglet "<a class="linkInText" href=".?page=search">Ajouter un Film/une Série</a>" puis entrez le nom du film ou de la série que vous souhaitez ajouter (la date est optionnelle) avec le type correspondant. Cette recherche ne prend que les titres anglais.</p>
        ...
        <p>Pour visionner les films et séries de la base de données allez dans l'onglet "<a class="linkInText" href=".?page=view">Voir les films</a>". Depuis cet onglet vous pouvez feuilleter à travers les films et séries en les triant selon votre choix. On peut aussi effectuer une recherche dans les résultats affichés, par exemple sur les titres, les directeurs, les acteurs, les genres, la localisation et les commentaires. Cette recherche compare avec écriture fixe (mais sans importance sur les majuscules et minuscules ou les accents). Exemple: rechercher "VINCì" donne comme résultat: "The Da Vinci Code" (parmi d'autres résultats possibles), mais rechercher "vincy" ne donne pas ce résultat, les films seront filtrés pendant que vous écrivez.</p>
        <p>On peut aussi sélectionner uniquement les films d'un certain genre/acteur/directeur en cliquant sur son nom depuis la liste ou la page d'un film.</p>
        <p>Un petit jeu de type Wordle est disponible dans l'onglet "<a class="linkInText" href="./syndle">Syndle</a>".</p>
